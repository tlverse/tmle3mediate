...
The natural direct and indirect effects are obtained by a decomposition of the
ATE:
\begin{equation*}
  \mathbb{E}[Y(1) - Y(0)] =
...
As with the NDE, the reparameterization trick allows us to estimate $E(A \mid Z,

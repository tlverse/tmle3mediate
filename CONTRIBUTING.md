# Contributing to `tmle3mediate` development

We, the authors of the `tmle3mediate` R package, use the same guide as is used for
...
The goal of this guide is to help you get up and contributing to `tmle3mediate` as
...
To contribute a change to `tmle3mediate`, you follow these steps:
...
3.  __Use `tmle3mediate` coding style__. Please follow the
